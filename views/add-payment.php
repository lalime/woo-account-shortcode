...
if ( $available_gateways ) : 
	...
	<?php else : ?>
		...
		<div class="woocommerce-pagination woocommerce-pagination--without-numbers woocommerce-Pagination">
			<a class="woocommerce-button woocommerce-button--next secudeal-Button button" href="<?php echo esc_url( add_query_arg( 'change_payment_method', 'true' ) ); ?>"><?php esc_attr_e( 'Add payment method', 'woocommerce' ); ?></a>
		</div>
	<?php endif; ?>
